...
read_parameters() {
  ...
  read -rp "Cluster ECS          [cluster-bia]: " ECS_CLUSTER
  ECS_CLUSTER="${ECS_CLUSTER:-cluster-bia}"

  read -rp "Service ECS          [service-bia]: " ECS_SERVICE
  ECS_SERVICE="${ECS_SERVICE:-service-bia}"
